export const scenario = {
  ...
  ep5: {
    ...
    steps: [
      {
        speaker: "나",
        text: "휴, 오늘 도서관 활동은 백과사전 때문에 진짜 힘들었네... 어라? 교문 뒤 가로등 아래 서 있는 거... 서선우잖아? 웬일로 저기서 뚱한 표정으로 차가운 캔음료를 만지작거리고 있대?",
        background: "sunset"
      },
      {
        speaker: "나",
      ...
      {
        speaker: "선우",
        text: "어, 나왔냐? ...누구는 도서관에서 학생회장 한지호 선배랑 단둘이 좋은 시간 보내느라 늦게 나온 줄 알았지.",
        character: "sunwoo",
        expression: "normal",
        effect: "fade-in",
        background: "sunset"
  ...
  ending_sunwoo_happy: {
    ...
    steps: [
      {
        speaker: "나",
        text: "선우야! 벚꽃 나무 아래서 보니까 너 진짜 멋있어 보인다? 맨날 장난만 치던 꼬맹이 서선우 맞냐?",
        background: "park"
      },
      {
        speaker: "선우",
        text: "하! 당연하지, 이 몸이 누구신데! 야, 내 모든 어제랑 오늘, 그리고 다가올 내일은 전부 다 너를 위해 존재하는 거야. 몰랐냐?",
        character: "sunwoo",
        expression: "smile",
        background: "park"
      },
      ...
      {
        speaker: "선우",
        text: "당연하지! 진짜 온 세상에서 네가 제일 행복한 여자애로 만들어 줄 테니까 나만 믿어! 아하하!",
        character: "sunwoo",
        expression: "smile",
        effect: "bounce",
        background: "park"
